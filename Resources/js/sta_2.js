  ...
  function main_func() {
      ...
      reader.onload = function() {
          document.write("<!doctype html><html><head><title>DAG Generator</title><link rel='stylesheet' type='text/css' href='Resources/css/myStyle.css' /></head><body style='background:#ebf0fa; color:#000000;'></body><button onclick=\"printr()\" style=\"float: right;\">Print Report</button><script>function printr() { window.print(); }</script></html>");
